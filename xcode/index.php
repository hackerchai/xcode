  ...
  <body>
    ...
    <p>
      <font face="Bodoni MT Black">
        Hey , programmer! Type or just copy the code you
        want to share.
      </font>
    </p>
    ...
    <form method="POST" action="post.php">
      <p>Author:<input type="text" name="name" size="20"></input></p>
      <p>Language:<select size="1" name="language" tabindex="0">
	                    <option>php</option>
	   ...
	   <p>Description:<input type="text" name="describe" size="100"></input></p>
