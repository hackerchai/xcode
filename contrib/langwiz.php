...
<body>
	...
	<p>
		To use this script, make sure that <strong>geshi.php</strong> is in
		the parent directory or in your include_path, and that the language
		files are in a subdirectory of GeSHi's directory called <strong>geshi/</strong>.
	</p>
	<p>If not already done, select a language file below that will be used
		as base for the language file to generate or create a blank one.
		Following this you can do whatever you like to edit your language
		file. But note that not all features are made available through this
		script.</p>
...
<form action="?action=test" method="post">
			<fieldset>
				...
				<table width="100%">
					<tr>
						<td><label for="li[file]">Language File ID:</label></td>
						<td><input type="text" name="li[file]" id="li[file]"
							value="<?=$li['file']; ?>" /></td>
					</tr>

					<tr>
						<td><label for="li[name]">Language Name:</label></td>
						<td><input type="text" name="li[name]" id="li[name]"
							value="<?=$li['name']; ?>" /></td>
					</tr>
			...
			<fieldset>
				...
				<table width="100%">
					<tr>
						<td><label for="ai[name]">Full Name:</label></td>
						<td><input type="text" name="ai[name]" id="ai[name]"
							value="<?=$ai['name']; ?>" /></td>
					</tr>

					<tr>
						<td><label for="ai[email]">eMail address:</label></td>
						<td><input type="text" name="ai[email]" id="ai[email]"
							value="<?=$ai['email']; ?>" /></td>
					</tr>

					<tr>
						<td><label for="ai[web]">Homepage:</label></td>
						<td><input type="text" name="ai[web]" id="ai[web]"
							value="<?=$ai['web']; ?>" /></td>
					</tr>
				</table>
			</fieldset>
			...
			<fieldset>
				...
				<fieldset>
					...
					<fieldset>
						...
						<table width="100%">
							<tr>
								<td><label for="ld[cmt][sl][1][start]">Comment Start:</label></td>
								<td><input type="text" name="ld[cmt][sl][1][start]"
									id="ld[cmt][sl][1][start]"
									value="<?=$ld['cmt']['sl'][1]['start']; ?>" /></td>
							</tr>

							<tr>
								<td><label for="ld[cmt][sl][1][style]">Comment Style:</label></td>
								<td><input type="text" name="ld[cmt][sl][1][style]"
									id="ld[cmt][sl][1][style]"
									value="<?=$ld['cmt']['sl'][1]['style']; ?>" /></td>
							</tr>
						</table>
					</fieldset>
					...
					<fieldset>
						...
						<table width="100%">
							<tr>
								<td><label for="ld[cmt][sl][2][start]">Comment Start:</label></td>
								<td><input type="text" name="ld[cmt][sl][2][start]"
									id="ld[cmt][sl][2][start]"
									value="<?=$ld['cmt']['sl'][2]['start']; ?>" /></td>
							</tr>

							<tr>
								<td><label for="ld[cmt][sl][2][style]">Comment Style:</label></td>
								<td><input type="text" name="ld[cmt][sl][2][style]"
									id="ld[cmt][sl][2][style]"
									value="<?=$ld['cmt']['sl'][2]['style']; ?>" /></td>
							</tr>
						</table>
					</fieldset>
				</fieldset>
				...
				<fieldset>
					...
					<fieldset>
						...
						<table width="100%">
							<tr>
								<td><label for="ld[cmt][ml][1][start]">Comment Start:</label></td>
								<td><input type="text" name="ld[cmt][ml][1][start]"
									id="ld[cmt][ml][1][start]"
									value="<?=$ld['cmt']['ml'][1]['start']; ?>" /></td>
							</tr>

							<tr>
								<td><label for="ld[cmt][ml][1][end]">Comment End:</label></td>
								<td><input type="text" name="ld[cmt][ml][1][end]"
									id="ld[cmt][ml][1][end]"
									value="<?=$ld['cmt']['ml'][1]['end']; ?>" /></td>
							</tr>

							<tr>
								<td><label for="ld[cmt][ml][1][style]">Comment Style:</label></td>
								<td><input type="text" name="ld[cmt][ml][1][style]"
									id="ld[cmt][ml][1][style]"
									value="<?=$ld['cmt']['ml'][1]['style']; ?>" /></td>
							</tr>
						</table>
					</fieldset>
					...
					<fieldset>
						...
						<table width="100%">
							<tr>
								<td><label for="ld[cmt][ml][2][start]">Comment Start:</label></td>
								<td><input type="text" name="ld[cmt][ml][2][start]"
									id="ld[cmt][ml][2][start]"
									value="<?=$ld['cmt']['ml'][2]['start']; ?>" /></td>
							</tr>

							<tr>
								<td><label for="ld[cmt][ml][2][end]">Comment End:</label></td>
								<td><input type="text" name="ld[cmt][ml][2][end]"
									id="ld[cmt][ml][2][end]"
									value="<?=$ld['cmt']['ml'][2]['end']; ?>" /></td>
							</tr>

							<tr>
								<td><label for="ld[cmt][ml][2][style]">Comment Style:</label></td>
								<td><input type="text" name="ld[cmt][ml][2][style]"
									id="ld[cmt][ml][2][style]"
									value="<?=$ld['cmt']['ml'][2]['style']; ?>" /></td>
							</tr>
						</table>
					</fieldset>
				</fieldset>
				...
				<fieldset>
					...
					<fieldset>
						...
						<table width="100%">
							<tr>
								<td><label for="ld[cmt][rxc][1][rx]">Comment RX:</label></td>
								<td><input type="text" name="ld[cmt][rxc][1][rx]"
									id="ld[cmt][rxc][1][rx]"
									value="<?=$ld['cmt']['rxc'][1]['rx']; ?>" /></td>
							</tr>

							<tr>
								<td><label for="ld[cmt][rxc][1][style]">Comment Style:</label></td>
								<td><input type="text" name="ld[cmt][rxc][1][style]"
									id="ld[cmt][rxc][1][style]"
									value="<?=$ld['cmt']['rxc'][1]['style']; ?>" /></td>
							</tr>
						</table>
					</fieldset>
				</fieldset>
			...
			<fieldset>
				...
				<fieldset>
					...
					<fieldset>
						...
						<table width="100%">
							<tr>
								<td><label for="ld[str][qm][1][delim]">String Delimiter:</label>
								</td>
								<td><input type="text" name="ld[str][qm][1][delim]"
									id="ld[str][qm][1][delim]"
									value="<?=$ld['str']['qm'][1]['delim']; ?>" /></td>
							</tr>

							<tr>
								<td><label for="ld[str][qm][1][style]">String Style:</label></td>
								<td><input type="text" name="ld[str][qm][1][style]"
									id="ld[str][qm][1][style]"
									value="<?=$ld['str']['qm'][1]['style']; ?>" /></td>
							</tr>
						</table>
					</fieldset>
					<fieldset>
						...
						<table width="100%">
							<tr>
								...
								<td><input type="text" name="ld[str][qm][2][delim]"
									id="ld[str][qm][2][delim]"
									value="<?=$ld['str']['qm'][2]['delim']; ?>" /></td>
							</tr>

							<tr>
								<td><label for="ld[str][qm][1][style]">String Style:</label></td>
								<td><input type="text" name="ld[str][qm][2][style]"
									id="ld[str][qm][2][style]"
									value="<?=$ld['str']['qm'][2]['style']; ?>" /></td>
							</tr>
						</table>
					</fieldset>
				...
				<fieldset>
					...
					<fieldset>
						...
						<table width="100%">
							<tr>
								<td><label for="ld[str][ec][char]">Escape Char:</label></td>
								<td><input type="text" name="ld[str][ec][char]"
									id="ld[str][ec][char]" value="<?=$ld['str']['ec']['char']; ?>" />
								</td>
							</tr>

							<tr>
								<td><label for="ld[str][ec][style]">Escape Char Style:</label></td>
								<td><input type="text" name="ld[str][ec][style]"
									id="ld[str][ec][style]"
									value="<?=$ld['str']['ec']['style']; ?>" /></td>
							</tr>
						</table>
					</fieldset>
					...
					<fieldset>
						...
						<table width="100%">
							<tr>
								<td><label for="ld[str][erx][1][rx]">Escape Regexp:</label></td>
								<td><input type="text" name="ld[str][erx][1][rx]"
									id="ld[str][erx][1][rx]"
									value="<?=$ld['str']['erx'][1]['rx']; ?>" /></td>
							</tr>

							<tr>
								<td><label for="ld[str][erx][1][style]">Escape Style:</label></td>
								<td><input type="text" name="ld[str][erx][1][style]"
									id="ld[str][erx][1][style]"
									value="<?=$ld['str']['erx'][1]['style']; ?>" /></td>
							</tr>
						</table>
					</fieldset>
					...
					<fieldset>
						...
						<table width="100%">
							<tr>
								<td><label for="ld[str][erx][2][rx]">Escape Regexp:</label></td>
								<td><input type="text" name="ld[str][erx][2][rx]"
									id="ld[str][erx][2][rx]"
									value="<?=$ld['str']['erx'][2]['rx']; ?>" /></td>
							</tr>

							<tr>
								<td><label for="ld[str][erx][2][style]">Escape Style:</label></td>
								<td><input type="text" name="ld[str][erx][2][style]"
									id="ld[str][erx][2][style]"
									value="<?=$ld['str']['erx'][2]['style']; ?>" /></td>
							</tr>
						</table>
					</fieldset>
				</fieldset>
			...
			<fieldset>
				...
				<fieldset>
					...
					<table width="100%">
						<tr>
							<td><label for="ld[kw_case]">Handling of keywords case:</label></td>
							<td><select name=ld[kw_case] " id="ld[kw_case]">
									<option value="GESHI_CAPS_NO_CHANGE"
										<?=$kw_case_sel['GESHI_CAPS_NO_CHANGE']; ?>>Don’t change the
										case of any keyword</option>
									<option value="GESHI_CAPS_UPPER"
										<?=$kw_case_sel['GESHI_CAPS_UPPER']; ?>>Convert the case of
										all keywords to upper case</option>
									<option value="GESHI_CAPS_LOWER"
										<?=$kw_case_sel['GESHI_CAPS_LOWER']; ?>>Convert the case of
										all keywords to lower case</option>
							</select></td>
						</tr>
					</table>
				</fieldset>
				...
				<fieldset>
					...
					<table width="100%">
						<tr>
							<td><label for="ld[kw][1][list]">Keyword List:</label></td>
							<td><textarea name="ld[kw][1][list]" id="ld[kw][1][list]"
									rows="10" cols="80"><?=$ld['kw'][1]['list']; ?></textarea></td>
						</tr>

						<tr>
							<td><label for="ld[kw][1][case]">Case Sensitive:</label></td>
							<td><select name="ld[kw][1][case]" id="ld[kw][1][case]">
						...
						<tr>
							<td><label for="ld[kw][1][style]">Keyword Style:</label></td>
							<td><input type="text" name="ld[kw][1][style]"
								id="ld[kw][1][style]" value="<?=$ld['kw'][1]['style']; ?>" /></td>
						</tr>

						<tr>
							<td><label for="ld[kw][1][docs]">Documentation URL:</label></td>
							<td><input type="text" name="ld[kw][1][docs]"
								id="ld[kw][1][docs]" value="<?=$ld['kw'][1]['docs']; ?>" /></td>
						</tr>
					</table>
				</fieldset>
			...
			<fieldset>
				...
				<fieldset>
					...
					<table width="100%">
						<tr>
							<td><label for="ld[sy][0][list]">Symbols List:</label></td>
							<td><textarea name="ld[sy][0][list]" id="ld[sy][0][list]"
									rows="10" cols="80"><?=$ld['sy'][0]['list']; ?></textarea></td>
						</tr>

						<tr>
							<td><label for="ld[sy][0][style]">Symbols Style:</label></td>
							<td><input type="text" name="ld[sy][0][style]"
								id="ld[sy][0][style]" value="<?=$ld['sy'][0]['style']; ?>" /></td>
						</tr>
					</table>
				</fieldset>
...
?> seconds.</p>
		...
		<div id="footer">GeSHi &copy; 2004-2007 Nigel McNie, 2007-2009 Benny
			Baumann, released under the GNU GPL</div>
