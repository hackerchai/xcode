...
$language_data = array( 
        ...
        'KEYWORDS' => array( 
                ...
                3 => array( 
                        ...
                        'kCommandTypeMatchScreenSpaceCenter' , 
                        ...
                        'kLockReadWrite' , 
                        // Network
                        'kBluetoothServerPort' , 
                        'kDefaultServerPort' , 
                        'kStatusAuthenticated' , 
                        'kStatusSearchFinished' ,  // 'kStatusNone', 'kStatusPending',
                                                  // Object
                        'kControllerTypeAI' , 
                        'kControllerTypeAnimation' , 
                        'kControllerTypeAny' , 
                        'kControllerTypeDynamics' , 
                        'kControllerTypeNavigation' , 
                        'kControllerTypeSound' , 
                        'kGlobalSpace' , 
                        'kLocalSpace' , 
                        'kParentSpace' , 
                        'kTransformOptionInheritsParentRotation' , 
                        'kTransformOptionInheritsParentScale' , 
                        'kTransformOptionInheritsParentTranslation' , 
                        'kTransformOptionTranslationAffectedByParentRotation' , 
                        ...
                        'kMapTypeTextureClip' , 
                        // Scene
                        'kFilteringModeBilinear' , 
                        'kFilteringModeNearest' , 
                        'kFilteringModeTrilinear' ,  // 'kAddressingModeClamp', 'kAddressingModeRepeat',
                        'kSkyBoxFaceBack' , 
                        'kSkyBoxFaceBottom' , 
                        'kSkyBoxFaceFront' , 
                        'kSkyBoxFaceLeft' , 
